...
public class VerticalBlockViewFactory extends BlockViewFactory<BlockView, InputView> {
    ...
    private BasicFieldListView.ListViewAdapter mListAdapter;
    ...
    protected FieldView buildFieldView(Field field) {
        ...
        switch (type) {
            ...
            case Field.TYPE_LIST: {
                BasicFieldListView listView = (BasicFieldListView) fieldView;
                listView.setAdapter(getListAdapter());
                listView.setListRequestCallback(mListCallback);
                break;
            }
            default:
                if (fieldView == null) {
    ...
    protected SpinnerAdapter getListAdapter() {
        ...
        if(mListAdapter == null) {
            BasicFieldListView.ListViewAdapter
                    adapter = new BasicFieldListView.ListViewAdapter(mContext, mListNameManager,
                    R.layout.default_spinner_closed_item2);
            adapter.setDropDownViewResource(R.layout.default_spinner_dropdown_item2);
    ...
    private void loadStyleData(int workspaceTheme) {
        ...
        try {
            ...
            setFieldLayout(Field.TYPE_LIST, R.layout.default_field_list);
        } finally {
            styles.recycle();
        }
    }
