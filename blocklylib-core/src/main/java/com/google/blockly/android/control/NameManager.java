...
public abstract class NameManager extends DataSetObservable {
    ...
    public static final class ListNameManager extends NameManager {
        private static final String LETTERS = "ijkmnopqrstuvwxyzabcdefgh"; // no 'l', start at i.
        private String mListPrefix;
         ...
         * Some languages need a '$' or a namespace before all variable names.
         *
         * @param listPrefix The prefix to attach.
         */
        public void setListPrefix(String listPrefix) {
            mListPrefix = listPrefix;
        }
         ...
         * @return New variable name.
         */
        public String generateListName(boolean addName) {
            String newName;
            int suffix = 1;
            while (true) {
                for (int i = 0; i < LETTERS.length(); i++) {
