...
public class ToolboxFragment extends BlockDrawerFragment {
    ...
    protected Button mActionListButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mActionListButton = (Button) inflater.inflate(R.layout.default_create_list_button, null);
        ...
        mActionListButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mController != null) {
                    mController.requestAddList("listitem");
                }
            }
        });
    ...
    public void setController(BlocklyController controller) {
        ...
        if (mController == null) {
            ...
            mActionListButton.setVisibility(View.GONE);
        }
    ...
    public void setCurrentCategory(@Nullable ToolboxCategory category) {
        ...
        if (category.isVariableCategory()) {
            ...
            mActionListButton.setVisibility(View.VISIBLE);
        } else {
            mActionButton.setVisibility(View.GONE);
            mActionListButton.setVisibility(View.GONE);
        }
    ...
    private void updateScrollablePadding() {
        ...
        int listButtonHeight = mActionListButton.getVisibility() == View.GONE ?
                0 : mActionListButton.getMeasuredHeight();
        int listButtonWidth = mActionListButton.getVisibility() == View.GONE ?
                0 : mActionListButton.getMeasuredWidth();
    ...
    private class ToolboxRoot extends ViewGroup {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            measureChild(mActionListButton, widthMeasureSpec, heightMeasureSpec);
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            switch (tabGravity) {
                case Gravity.LEFT:
                    ...
                    mActionListButton.layout(tabRight + mActionButton.getMeasuredWidth(), 0, tabRight + mActionListButton.getMeasuredWidth() + mActionButton.getMeasuredWidth(),
                            mActionListButton.getMeasuredHeight());
                    break;
                case Gravity.RIGHT:
                    mActionButton.layout(tabLeft - mActionButton.getMeasuredWidth(), 0, tabLeft,
                            mActionButton.getMeasuredHeight());
                    mActionListButton.layout(tabLeft - mActionListButton.getMeasuredWidth(), 0, tabLeft,
                            mActionListButton.getMeasuredHeight());
                    break;
                case Gravity.TOP:
                    if (layoutDir == ViewCompat.LAYOUT_DIRECTION_LTR) {
                        ...
                        mActionListButton.layout(0, tabBottom, mActionListButton.getMeasuredWidth(),
                                tabBottom + mActionListButton.getMeasuredHeight());
                    } else {
                        mActionButton.layout(width - mActionButton.getMeasuredWidth(), tabBottom,
                                width, tabBottom + mActionButton.getMeasuredHeight());
                        mActionListButton.layout(width - mActionListButton.getMeasuredWidth(), tabBottom,
                                width, tabBottom + mActionListButton.getMeasuredHeight());
                    }
                    break;
                case Gravity.BOTTOM:
                    if (layoutDir == ViewCompat.LAYOUT_DIRECTION_LTR) {
                        ...
                        mActionListButton.layout(0, tabTop - mActionListButton.getMeasuredHeight(),
                                mActionListButton.getMeasuredWidth(), tabTop);
                    } else {
                        mActionButton.layout(width - mActionButton.getMeasuredWidth(),
                                tabTop - mActionButton.getMeasuredHeight(), width, tabTop);
                        mActionListButton.layout(width - mActionListButton.getMeasuredWidth(),
                                tabTop - mActionListButton.getMeasuredHeight(), width, tabTop);
                    }
                    break;
            }
        }
