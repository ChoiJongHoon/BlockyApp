...
import com.google.blockly.android.ui.fieldview.BasicFieldListView;
...
public abstract class BlockViewFactory<BlockView extends com.google.blockly.android.ui.BlockView,
    ...
    protected NameManager mListNameManager;
    /**
    ...
    protected ListRequestCallback mListCallback;
    ...
    public void setListRequestCallback(ListRequestCallback callback) {
    ...
    public void setListNameManager(NameManager listNameManager) {
    ...
    protected FieldView buildFieldView(Field field) {
        ...
        switch (type) {
            ...
            case Field.TYPE_LIST: {
                BasicFieldListView fieldListView = new BasicFieldListView(mContext);
                fieldListView.setAdapter(getListAdapter());
                fieldListView.setField((FieldList)field);
                fieldListView.setListRequestCallback(mListCallback);
    ...
    protected SpinnerAdapter getListAdapter() {
        if(mListNameManager == null) {
            throw new IllegalStateException("NameManager must be set before list field is "
                    + "instantiated.");
        }
        if(mListAdapter == null) {
            mListAdapter = new BasicFieldListView.ListViewAdapter(mContext, mListNameManager,
                    android.R.layout.simple_spinner_item);
        }
        return mListAdapter;
    }
