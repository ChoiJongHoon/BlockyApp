...
public class Block {
    ...
    void setShadow(boolean isShadow) {
        ...
        if (isShadow) {
            ...
            if(containsListField(mInputList)) {
                throw new IllegalStateException("Shadow blocks cannot contain list fields.");
            }
    ...
    boolean containsListField() { return containsListField(mInputList); }
    ...
    private static boolean containsListField(ArrayList<Input> inputs) {
        int inputCount = inputs.size();
        for(int i = 0; i< inputCount; i++) {
            Input in = inputs.get(i);
            List<Field> fields = in.getFields();
    ...
    public static class Builder {
        ...
        public Block build() {
            ...
            if(mIsShadow && containsListField(mInputs)) {
                throw new IllegalArgumentException("Shadow blocks cannot contain lists");
            }
